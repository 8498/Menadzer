...
public class Trenerzytabela {
	
	private boolean DEBUG = false;
	private PrintStream c;
	  public Trenerzytabela() {
	...
	try {
				...
				int port = 4443; //1064 bylo wczesniej
				...
				ResultSet rs = stmt.executeQuery("SELECT ID, Imie, Nazwisko, Pensja FROM Trenerzy;");
	      ...
	      while (rs.next()) {
	        ...
	        String pwx=rs.getString("Pensja");
