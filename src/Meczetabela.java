...
public class Meczetabela {
	...
	private PrintStream c;
	  public Meczetabela() {
		  Vector<String> columnNames = new Vector<String>();
	        ...
	        columnNames.addElement("Przeciwnik");
	        columnNames.addElement("Wynik");
	...
	try {
				...
				ResultSet rs = stmt.executeQuery("SELECT ID, Przeciwnik, Wynik FROM Mecze;");
				System.out.println("# - Query Executed");
	      Vector<Vector> wiersz = new Vector<Vector>();
	      while (rs.next()) {

	        String pid=rs.getString("ID");
	        String pim=rs.getString("Przeciwnik");
	        String pna=rs.getString("Wynik");
	        ...
	        tabelka.getColumnModel().getColumn(2).setMaxWidth(50);
